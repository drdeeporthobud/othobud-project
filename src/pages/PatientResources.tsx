...
const faqs = [
  {
    ...
    items: [
      {
        q: "Do I need a referral to see Dr. Deep?",
        a: "No referral is required. You can book directly via this website, phone, or WhatsApp.",
      },
      {
        q: "What tests do I need before a consultation?",
        a: "For a first consultation, please bring any existing X-rays, MRI or CT reports. Dr. Deep will advise on additional investigations as required.",
      },
      {
        q: "How do I know if I need surgery?",
        a: "Surgery is only recommended when conservative management (physiotherapy, medication, injections) has failed to provide adequate relief, or when there is significant structural damage. Dr. Deep will explain all options before any recommendation.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "How long will I stay in hospital after joint replacement?",
        a: "Most patients are discharged within 3–5 days after a knee or hip replacement. Robotic procedures often allow earlier discharge.",
      },
      {
        q: "When can I drive after knee replacement?",
        a: "Most patients can drive after 6–8 weeks, provided they are not on prescription pain medication and have adequate reflexes. Your surgeon will confirm this at your follow-up.",
      },
      {
        q: "Is physiotherapy compulsory after surgery?",
        a: "Yes — physiotherapy is an essential part of recovery. A structured rehabilitation programme begins from the first day post-surgery.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "Does Dr. Deep accept cashless insurance?",
        a: "Yes. Cashless treatment is available through empanelled hospitals for most major health insurance providers. Please confirm your insurer with our clinic coordinator.",
      },
      {
        q: "What is the consultation fee?",
        a: "Consultation fees vary by clinic. Please contact us at +91 79801 44046 for current fee details.",
      },
    ],
  },
]
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="bg-navy py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 mt-4 max-w-xl mx-auto">
            Everything you need to prepare, recover and thrive — guides, videos,
            FAQs, and real patient stories.
          </p>
        </div>
      </section>
      ...
      {activeTab === "Guides" && (
        <section className="py-16 bg-soft-gray" ref={guidesRef}>
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="font-display font-800 text-3xl text-navy mb-8 reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {guides.map((g, i) => (
                <div
                  key={g.title}
                  className={`reveal reveal-delay-${(i % 6) + 1} bg-white rounded-2xl p-6 border border-border/50 card-hover`}
                >
                  ...
                  <span className="text-xs text-teal font-700 bg-teal/10 px-3 py-1 rounded-full">
                    {g.tag}
                  </span>
                  <h3 className="font-display font-700 text-navy text-lg mt-3">
                    {g.title}
                  </h3>
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  {
                    title: "Post-Knee Replacement: Week 1–2 Exercises",
                    duration: "12 min",
                  },
                  {
                    title: "Hip Replacement: Safe Movements Guide",
                    duration: "15 min",
                  },
                  {
                    title: "ACL Recovery: Return to Sport Protocol",
                    duration: "20 min",
                  },
                ].map((video, i) => (
                  <div
                    key={video.title}
                    className={`reveal reveal-delay-${i + 1} bg-white rounded-2xl overflow-hidden border border-border/50 card-hover`}
                  >
                    <div className="aspect-video bg-navy-800 relative flex items-center justify-center">
                      <img
                        ...
                        }?w=400&h=225&fit=crop&auto=format`}
                        alt={video.title}
                    ...
                    <div className="p-4">
                      <h3 className="font-display font-700 text-navy text-sm">
                        {video.title}
                      </h3>
                      <p className="text-xs text-navy-700 mt-1">
                        By Dr. Deep Chakraborty
                      </p>
                    </div>
                  </div>
                ))}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((t, i) => (
                <div
                  key={t.name}
                  className={`reveal reveal-delay-${(i % 6) + 1} bg-white rounded-2xl p-7 border border-border/50 card-hover`}
                >
                  <div className="text-teal text-lg mb-4">
                    {"★".repeat(t.stars)}
                  </div>
                  ...
                  <div className="flex items-center gap-3 mt-6 pt-5 border-t border-border/50">
                    ...
                    />
                    <div>
                      <div className="font-display font-700 text-navy text-sm">
                        {t.name}
                      </div>
                    ...
                    <div className="ml-auto text-xs text-teal font-semibold">
                      Google ★
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              {faqs.map((section) => (
                <div key={section.category}>
                  <h3 className="font-display font-700 text-teal text-sm uppercase tracking-widest mb-4">
                    {section.category}
                  </h3>
      ...
      {activeTab === "Downloads" && (
        <section className="py-16 bg-soft-gray">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="font-display font-800 text-3xl text-navy mb-8">
              Patient Downloads
            </h2>
            <div className="space-y-3">
              {[
                ...
                {
                  title: "Post-Operative Exercise Programme — Knee",
                  size: "3.5 MB",
                  type: "PDF",
                },
                {
                  title: "Post-Operative Exercise Programme — Hip",
                  size: "3.1 MB",
                  type: "PDF",
                },
                {
                  title: "Diet & Nutrition Guide for Recovery",
                  size: "0.8 MB",
                  type: "PDF",
                },
                {
                ...
                <div
                  key={doc.title}
                  className="flex items-center justify-between bg-white rounded-xl border border-border/60 px-5 py-4"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center">
                      <span className="text-red-600 font-display font-800 text-xs">
                        PDF
                      </span>
                    </div>
                    <div>
                      <div className="font-display font-600 text-navy text-sm">
                        {doc.title}
                      </div>
      ...
      <section className="py-16 bg-teal">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 mt-3">
            Speak directly with Dr. Deep's care team or book a consultation.
          </p>
          <div className="flex flex-wrap gap-4 justify-center mt-7">
            <Link
              to="/book-appointment"
              className="bg-white text-teal font-display font-700 px-7 py-3 rounded-xl hover:bg-soft-gray transition-colors"
            >
              Book Appointment
            </Link>
            <a
              href="https://wa.me/917980144046"
              className="bg-white/20 text-white border border-white/30 font-display font-700 px-7 py-3 rounded-xl hover:bg-white/30 transition-colors"
            >
              WhatsApp Us
            </a>
          </div>
