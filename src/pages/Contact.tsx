...
const clinics = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
  {
    name: "Fortis",
    ...
    image:
      "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1512678080530-7760d81faba6?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581056771107-24ca5f033842?w=600&h=350&fit=crop&auto=format",
    mapEmbed: null,
  },
]
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="bg-navy py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 mt-4 max-w-lg mx-auto">
            Reach Dr. Deep's clinic team via phone, WhatsApp, or the enquiry
            form below. Same-day responses during clinic hours.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12">
            <a
              ...
              className="flex items-center gap-2 text-white font-display font-600 text-sm"
            >
              <svg
                width="16"
                height="16"
            ...
            <a
              href="mailto:drdeep.orthobud@gmail.com"
              className="flex items-center gap-2 text-white font-display font-600 text-sm"
            >
              <svg
                width="16"
      ...
      <section className="py-16 bg-soft-gray" ref={ref}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="section-label mb-2 reveal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {clinics.map((clinic, i) => (
              <div
                key={clinic.name}
                className={`reveal reveal-delay-${(i % 3) + 2} bg-white rounded-2xl border border-border/50 overflow-hidden card-hover flex flex-col justify-between`}
              >
                <div>
                  ...
                  <div className="p-6 pb-2">
                    <h3 className="font-display font-700 text-navy text-lg">
                      {clinic.name}
                    </h3>
                    <div className="space-y-3 mt-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="text-navy-700 text-sm leading-snug">
                            {clinic.address}
                          </div>
                          <div className="text-xs text-navy-700/60 mt-0.5">
                            {clinic.landmark}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm font-semibold text-teal leading-snug">
                          {clinic.timing}
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <a
                          ...
                          className="text-sm text-navy-700 hover:text-teal transition-colors"
                        >
                          {clinic.phone}
                        </a>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="font-display font-800 text-4xl text-navy mb-6">
                Enquiry Form
              </h2>
              <p className="text-navy-700 leading-relaxed mb-8">
                For non-urgent enquiries, fill in the form and our team will
                respond within one business day. For urgent concerns, please
                call directly.
              </p>
              ...
              {submitted ? (
                <div className="bg-teal/10 border border-teal/30 rounded-2xl p-8 text-center">
                  ...
                  <h3 className="font-display font-700 text-navy text-xl">
                    Message Received
                  </h3>
            ...
            <div className="space-y-6">
              <div className="bg-soft-gray rounded-2xl p-7">
                <h3 className="font-display font-700 text-navy text-lg mb-5">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      label: "Manipal Broadway",
                      time: "Mon & Fri: 4:00 PM – 5:00 PM",
                    },
                    {
                      label: "Narayana Barasat",
                      time: "Wed & Sat: 12:00 PM – 2:00 PM",
                    },
                    {
                      label: "Fortis Anandapur",
                      time: "Sat: 3:00 PM – 5:00 PM",
                    },
                    {
                      label: "Daffodil Laketown",
                      time: "Wed: 7:30 PM | Sat: 10:30 AM",
                    },
                    {
                      label: "Apollo Clinic Newtown",
                      time: "Tue, Thu, Fri, Sun: 4:30 PM",
                    },
                  ].map((loc) => (
                    <div
                      key={loc.label}
                    ...
                    >
                      ...
                      <span className="text-teal font-semibold text-right text-xs">
                        {loc.time}
                      </span>
                    </div>
                  ))}
                  <div className="pt-4 border-t border-border/50">
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-display font-700 text-navy">
                        Emergency Line:
                      </span>
                      <a
                        href="tel:+917980144046"
              ...
              <div className="bg-soft-gray rounded-2xl p-7">
                <h3 className="font-display font-700 text-navy text-lg mb-4">
                  Frequently Used Contacts
                </h3>
                <div className="space-y-3">
                  {[
                    {
                      label: "Main Enquiries",
                      val: "+91 79801 44046",
                      type: "phone",
                    },
                    {
                    ...
                    >
                      ...
                      <span className="font-display font-600 text-teal">
                        {c.val}
                      </span>
                    </div>
                  ))}
