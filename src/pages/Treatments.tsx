...
const treatments = [
  {
    ...
    symptoms: [
      "Severe knee pain not relieved by medication",
    ...
    description:
      "State-of-the-art robotic-assisted total knee replacement with sub-millimeter implant placement accuracy, resulting in faster recovery and longer implant life.",
  },
  {
    category: "Joint Replacement",
    ...
    symptoms: [
      "Groin or hip pain affecting daily activity",
      "Limping and leg shortening",
      "Stiffness limiting range of motion",
      "Failed conservative management",
    ],
    recovery: "8–12 weeks",
    description:
      "Minimally invasive total hip replacement using modern ceramic, metal and polyethylene implants with customized sizing for optimal function.",
  },
  {
    category: "Joint Replacement",
    ...
    symptoms: [
      "Localized knee arthritis (medial or lateral)",
      "Bone-on-bone contact in one compartment",
      "Good ligament integrity",
      "Active patients under 70",
    ],
    recovery: "4–6 weeks",
    description:
      "A conservative surgical option for patients with arthritis affecting only one compartment, preserving healthy bone and faster rehabilitation.",
  },
  {
    ...
    recovery: "2–6 weeks",
    description:
      "Key-hole surgery for diagnosis and treatment of knee joint pathologies including meniscal tears, cartilage damage, ligament reconstruction and loose body removal.",
  },
  {
    ...
    symptoms: [
      "Knee instability during pivoting",
      "Immediate swelling after injury",
      "Pop sensation at time of injury",
      "Inability to continue sporting activity",
    ],
    recovery: "9–12 months to return to sport",
    description:
      "Anatomic ACL reconstruction using hamstring or patellar tendon graft with accelerated rehabilitation protocols designed for athletes.",
  },
  {
    category: "Sports Medicine",
    ...
    symptoms: [
      ...
      "SLAP lesion",
      "Frozen shoulder unresponsive to physio",
    ],
    recovery: "3–6 months",
    description:
      "Minimally invasive shoulder surgery for rotator cuff repairs, bankart repairs, SLAP repairs and subacromial decompression.",
  },
  {
    category: "Trauma",
    ...
    description:
      "Surgical fixation of complex fractures using modern plates, intramedullary nails and fixators with early mobilization protocols.",
  },
  {
    category: "Pediatric",
    ...
    description:
      "Specialized orthopedic care for growing children — from congenital deformities and developmental issues to sports injuries and fractures.",
  },
]
    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-border/60 hover:border-teal/30 hover:shadow-lg transition-all duration-300 card-hover reveal flex flex-col h-full">
      ...
      <div className="p-6 flex-1 flex flex-col">
        <div className="flex items-center gap-1.5 mb-2 text-xs text-navy-700/80 font-medium">
          ...
          <span>
            Recovery:{" "}
            <strong className="text-navy font-600">{t.recovery}</strong>
          </span>
        </div>
        ...
        {expanded && (
          <div className="mt-4 pt-4 border-t border-border/50 space-y-3 animate-fade-up">
            <div>
              <div className="text-xs font-700 text-navy uppercase tracking-wider mb-2">
      ...
      <section className="bg-navy py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 mt-4 max-w-xl mx-auto leading-relaxed text-sm sm:text-base">
            Comprehensive orthopedic care ranging from minimally invasive
            arthroscopy to advanced robotic joint replacement.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-navy-700 mt-3 leading-relaxed text-sm sm:text-base">
            Book a consultation and Dr. Deep will evaluate your condition with a
            thorough examination and imaging review before recommending the
            appropriate care pathway.
          </p>
          <Link
            to="/book-appointment"
            className="btn-primary mt-7 inline-flex text-sm sm:text-base"
          >
            Book a Consultation →
          </Link>
        </div>
