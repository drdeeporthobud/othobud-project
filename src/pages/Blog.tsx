...
import { posts, categories, type BlogPost } from "../data/blogData"
      ...
      <section className="bg-navy py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 mt-4 max-w-lg mx-auto">
            Evidence-based orthopedic knowledge — written by Dr. Deep
            Chakraborty to help patients make informed decisions.
          </p>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-soft-gray rounded-3xl overflow-hidden border border-border/50">
              ...
              <div className="p-8 lg:py-12 lg:pr-12">
                ...
                <h2 className="font-display font-800 text-2xl text-navy mt-4 leading-snug">
                  {featured.title}
                </h2>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {featured.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs bg-white border border-border/60 text-navy-700 px-3 py-1 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
          ...
          {filtered.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtered.map((post, i) => (
                <div
                  key={post.title}
                  className={`reveal reveal-delay-${(i % 6) + 1} group bg-white rounded-2xl overflow-hidden border border-border/50 card-hover`}
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-xs font-700 text-teal bg-teal/10 px-3 py-1 rounded-full">
                        {post.category}
                      </span>
                    ...
                    <p className="text-sm text-navy-700 mt-2 leading-relaxed line-clamp-2">
                      {post.excerpt}
                    </p>
      ...
      <section className="py-16 bg-navy">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 mt-3 text-sm">
            Get new articles and patient guides delivered to your inbox — no
            spam, ever.
          </p>
