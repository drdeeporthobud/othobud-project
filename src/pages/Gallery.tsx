...
const categories = ['All', 'Consultations', 'Conferences', 'Workshops', 'Facilities', 'Community', 'Media', 'Achievements']
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="bg-navy py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="section-label" style={{ color: '#0EA5E9' }}>Visual Journey</div>
          <h1 className="font-display font-800 text-5xl text-white mt-2">Gallery</h1>
          <p className="text-white/70 mt-4 max-w-lg mx-auto">
            A window into Dr. Deep's clinical practice, academic contributions, community outreach and professional achievements.
          </p>
        </div>
      </section>
            ...
            {filtered.map((img, i) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  <span className="text-xs text-teal-light font-700 uppercase tracking-wide">{img.category}</span>
                  <h3 className="font-display font-700 text-white text-base mt-1">{img.title}</h3>
                  <p className="text-white/70 text-xs mt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">{img.desc}</p>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="p-6 flex items-start justify-between">
              <div>
                <span className="text-xs text-teal-light font-700 uppercase tracking-wide">{lightbox.category}</span>
                <h3 className="font-display font-700 text-white text-lg mt-1">{lightbox.title}</h3>
