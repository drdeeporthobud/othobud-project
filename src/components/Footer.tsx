...
export default function Footer() {
  ...
  const hideCta =
    location.pathname === "/book-appointment" || location.pathname === "/admin"
      ...
      {!hideCta && (
        <div className="bg-teal">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div>
              <h3 className="font-display font-700 text-lg sm:text-xl text-white">
                Ready to start your recovery journey?
              </h3>
              <p className="text-white/85 mt-1 text-xs sm:text-sm max-w-xl">
                Book a consultation with Dr. Deep Chakraborty across Newtown,
                Salt Lake, Barasat, Lake Town, or Anandapur.
              </p>
            </div>
            <Link
              to="/book-appointment"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/65 text-xs sm:text-sm leading-relaxed mb-6">
              Specialized orthopedic surgery and joint restoration across
              Kolkata. Advanced minimally invasive & robotic care.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-700 text-xs uppercase tracking-widest text-white/50 mb-4 sm:mb-5">
              Quick Links
            </h4>
              ...
              {footerClinics.map((clinic) => (
                <li key={clinic.name} className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0">
                    <div className="text-white/95 text-xs font-semibold leading-snug">
                      {clinic.name}
                    </div>
                    <div className="text-white/55 text-[11px] mt-0.5 leading-snug">
                      {clinic.timing}
                    </div>
                  </div>
                </li>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-center sm:text-left">
          <p className="text-white/45 text-xs leading-relaxed">
            © 2026 Orthobud · Dr. Deep Chakraborty (MS Ortho · Fellowships USA,
            Dubai & Kolkata). All rights reserved.
          </p>
